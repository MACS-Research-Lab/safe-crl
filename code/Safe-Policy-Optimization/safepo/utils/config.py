...
def single_agent_args():
    custom_parameters = [
        ...
        {"name": "--ewc-lambda", "type": float, "default": 1, "help": "tradeoff between current task and previous tasks for elastic weight consolidation"},
        {"name": "--task-length", "type": int, "default": 1_000_000, "help": "number of timesteps in each task"},
        {"name": "--tasks", "type": str, "default": None, "help": "list of tasks as a string. Ex: '[0, 1, 0, 1, 2, 0]'"},
    ]
